      ...
      <div className="flex my-6">
        <sidebar className="col-2">
            ...
            >
              <div className="mat-tab-labels">
                <div
                  ...
                  className="mat-ripple mat-tab-label mat-focus-indicator ng-star-inserted mat-tab-label-active"
                ...
                >
                  <div className="mat-tab-label-content">
                    <p className="lefttb ng-star-inserted">
                      <span className="numb ng-star-inserted"> 1 </span>
                      Buyer Details
                    </p>
                  </div>
                </div>
                <div
                  ...
                  mat-ripple=""
                  cdkmonitorelementfocus=""
                  className="mat-ripple mat-tab-label mat-focus-indicator ng-star-inserted mat-tab-disabled"
                ...
                >
                  <div className="mat-tab-label-content">
                    <p className="lefttb ng-star-inserted">
                      {/**/}
                      <span className="numb ng-star-inserted"> 2 </span>
                      {/**/} Pickup Details
                    </p>
                    {/**/}
                    {/**/}
                ...
                <div
                  ...
                  mat-ripple=""
                  cdkmonitorelementfocus=""
                  className="mat-ripple mat-tab-label mat-focus-indicator mat-tab-disabled ng-star-inserted"
                ...
                >
                  <div className="mat-tab-label-content">
                    <p className="lefttb ng-star-inserted">
                      {/**/}
                      <span className="numb ng-star-inserted"> 3 </span>
                      {/**/} Order Details
                    </p>
                    {/**/}
                    {/**/}
                ...
                >
                  <div className="mat-tab-label-content">
                    <p className="lefttb ng-star-inserted">
                      <span className="numb"> 4 </span>Package Details
                    </p>
          ...
          <div
            aria-hidden="true"
            mat-ripple=""
            className="mat-ripple mat-tab-header-pagination mat-tab-header-pagination-after mat-elevation-z4"
          >
            <div className="mat-tab-header-pagination-chevron" />
          </div>
        </sidebar>
            ...
            >
                ...
                <form className="text-sm">
                  ...
                  >
                    ...
                    {/* optional row  */}
                    <div className="row mt-4 text-xs text-[var(--primary-color)]">
                    ...
                    <div className="mt-4">
                      <p>
                        ...
                        >
                          <input
                            type="checkbox"
                            onChange={(e)=>{setIsBillingAddressSame(!isBillingAddressSame)}}
                  ...
                  <div className="text-end">
                    <button
                      type="button"
                      className="nxtbtn fs-14px sfpro-semibold rounded-6px w-8rem h-3rem"
                    >
                      {" "}
                      Next{" "}
                    </button>
