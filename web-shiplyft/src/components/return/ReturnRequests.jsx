      ...
      <table className="table-fixed w-full border-collapse">
        ...
        <thead>
          <tr className="bg-white text-black  shadow-lg rounded-md">
            <th className="p-2 md:p-3 text-left border-b font-normal w-36 rounded-s-md">Request ID & Date</th>
            ...
            <th className="p-2 md:p-3 text-left w-36 font-normal border-b">Return Reason</th>
