      ...
      <table className="table-fixed w-full border-collapse">
        ...
        <thead>
          <tr className="bg-white text-black  shadow-lg rounded-md">
            ...
            <th className="p-2 md:p-3 text-left w-36 font-normal border-b">Warehouse Address</th>
            <th className="p-2 md:p-3 text-left w-36 font-normal border-b">Refund Details</th>
            <th className="p-2 md:p-3 text-left w-36 font-normal border-b rounded-e-md"> Status </th>
